...
this.obj.onmousemove=function(i){var s=1==this.fishy.axis?(i?i.pageX:window.event.x+document.body.scrollLeft-2)-this.fishy.obj_left:(i?i.pageY:window.event.y+document.body.scrollTop-2)-this.fishy.obj_left
